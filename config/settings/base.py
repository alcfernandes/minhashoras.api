...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'minhashoras_apps.core.custom_paginations.CustomPageNumberPagination',
    'PAGE_SIZE': 100,
}
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(
        minutes=config('ACCESS_TOKEN_LIFETIME_IN_MINUTES', default=5, cast=int)
    ),
